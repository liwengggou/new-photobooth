...
export const newyorkSystemInstruction = ""; // Not currently used

export const newyorkMasterPrompt = `Transform this photo into an authentic vintage American photo booth portrait.
...
export const newyorkMatchPrompt = "";

export const newyorkBackgroundColor = { r: 96, g: 96, b: 96 }; // Medium-dark gray #606060
